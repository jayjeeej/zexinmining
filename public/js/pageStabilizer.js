  ...
  try {
    ...
    function createStyleElement() {
      ...
      style.innerHTML = `
        ...
        *:not(.mobile-menu):not(.mobile-menu *):not(.mobile-menu-content):not(.mobile-menu-content *):not(.mobile-menu li):not(.mobile-menu li *):not(.search-dropdown):not(.search-dropdown *):not(.dropdown-menu):not(.dropdown-menu-content):not(.scroll-progress-bar):not(.category-card):not(.product-card):not(.accordion):not(.accordion *):not([data-accordion]):not([data-accordion] *):not([data-accordion-item]):not([data-accordion-item] *):not([data-accordion-content]):not([data-accordion-content] *):not([data-accordion-trigger]):not([data-accordion-trigger] *):not(.full-table):not(.full-table *):not([data-full-table]):not([data-full-table] *):not([class*="table"]):not([class*="table"] *):not(button):not(button *):not([role="button"]):not([role="button"] *):not([class*="collapse"]):not([class*="collapse"] *):not([class*="expand"]):not([class*="expand"] *):not(dialog):not(dialog *):not([role="dialog"]):not([role="dialog"] *):not(.modal):not(.modal *):not(.modal-dialog):not(.modal-dialog *):not(.modal-backdrop):not(.modal-backdrop *):not([data-faq]):not([data-faq] *):not([data-features]):not([data-features] *):not([data-specs]):not([data-specs] *):not(#features):not(#features *):not(#faqs):not(#faqs *):not([id^="accordion-content-"]):not([id^="accordion-content-"] *):not([class*="transition-all"]):not([class*="duration-300"]):not([class*="ease-in-out"]):not([class*="max-h-"]):not([class*="opacity-"]):not([class*="rotate-"]) {
