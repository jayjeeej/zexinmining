/**
 * 页面稳定器脚本 - 处理导航返回时的状态恢复
 * 这个脚本确保在用户使用浏览器的后退/前进按钮时，页面状态能够正确恢复
 */
(function() {
  try {
    // 检查环境
    ...
    function createStyleElement() {
      ...
      style.innerHTML = `
        ...
        body.page-transitioning *:not(html.animation-ready .transition-all):not(html.animation-ready span[class*="transition-transform"]):not(html.animation-ready .category-card):not(html.animation-ready .product-card):not(html.animation-ready .dropdown-menu):not(html.animation-ready .dropdown-menu-content):not(html.animation-ready .scroll-progress-bar):not(html.animation-ready .mobile-menu):not(html.animation-ready .mobile-menu-content):not(html.animation-ready .search-dropdown):not(html.animation-ready .search-dropdown *):not(html.animation-ready .accordion):not(html.animation-ready .accordion *):not(html.animation-ready [data-accordion]):not(html.animation-ready [data-accordion] *):not(html.animation-ready .full-table):not(html.animation-ready .full-table *):not(html.animation-ready [data-full-table]):not(html.animation-ready [data-full-table] *):not([class*="table"]):not([class*="table"] *):not(html.animation-ready button):not(html.animation-ready button *):not([role="button"]):not([role="button"] *):not([class*="collapse"]):not([class*="collapse"] *):not([class*="expand"]):not([class*="expand"] *):not(html.animation-ready dialog):not(html.animation-ready dialog *):not(html.animation-ready [role="dialog"]):not(html.animation-ready [role="dialog"] *):not(html.animation-ready .modal):not(html.animation-ready .modal *):not(html.animation-ready .modal-dialog):not(html.animation-ready .modal-dialog *):not(html.animation-ready .modal-backdrop):not(html.animation-ready .modal-backdrop *),
        body *:not(html.animation-ready .transition-all):not(html.animation-ready span[class*="transition-transform"]):not(html.animation-ready .category-card):not(html.animation-ready .product-card):not(html.animation-ready .dropdown-menu):not(html.animation-ready .dropdown-menu-content):not(html.animation-ready .scroll-progress-bar):not(html.animation-ready .mobile-menu):not(html.animation-ready .mobile-menu-content):not(html.animation-ready .search-dropdown):not(html.animation-ready .search-dropdown *):not(html.animation-ready .accordion):not(html.animation-ready .accordion *):not(html.animation-ready [data-accordion]):not(html.animation-ready [data-accordion] *):not(html.animation-ready .full-table):not(html.animation-ready .full-table *):not(html.animation-ready [data-full-table]):not(html.animation-ready [data-full-table] *):not([class*="table"]):not([class*="table"] *):not(html.animation-ready button):not(html.animation-ready button *):not([role="button"]):not([role="button"] *):not([class*="collapse"]):not([class*="collapse"] *):not([class*="expand"]):not([class*="expand"] *):not(html.animation-ready dialog):not(html.animation-ready dialog *):not(html.animation-ready [role="dialog"]):not(html.animation-ready [role="dialog"] *):not(html.animation-ready .modal):not(html.animation-ready .modal *):not(html.animation-ready .modal-dialog):not(html.animation-ready .modal-dialog *):not(html.animation-ready .modal-backdrop):not(html.animation-ready .modal-backdrop *) {
