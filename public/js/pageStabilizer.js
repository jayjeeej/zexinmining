  ...
  try {
    ...
    function createStyleElement() {
      ...
      style.innerHTML = `
        ...
        body.page-transitioning *:not(html.animation-ready .transition-all):not(html.animation-ready span[class*="transition-transform"]):not(html.animation-ready .category-card):not(html.animation-ready .product-card):not(html.animation-ready .dropdown-menu):not(html.animation-ready .dropdown-menu-content):not(html.animation-ready .scroll-progress-bar):not(html.animation-ready .mobile-menu):not(html.animation-ready .mobile-menu-content):not(html.animation-ready .search-dropdown):not(html.animation-ready .search-dropdown *):not(html.animation-ready .accordion):not(html.animation-ready .accordion *):not(html.animation-ready [data-accordion]):not(html.animation-ready [data-accordion] *):not(html.animation-ready .full-table):not(html.animation-ready .full-table *):not(html.animation-ready [data-full-table]):not(html.animation-ready [data-full-table] *):not([class*="table"]):not([class*="table"] *):not(html.animation-ready button):not(html.animation-ready button *):not([role="button"]):not([role="button"] *):not([class*="collapse"]):not([class*="collapse"] *):not([class*="expand"]):not([class*="expand"] *),
        body *:not(html.animation-ready .transition-all):not(html.animation-ready span[class*="transition-transform"]):not(html.animation-ready .category-card):not(html.animation-ready .product-card):not(html.animation-ready .dropdown-menu):not(html.animation-ready .dropdown-menu-content):not(html.animation-ready .scroll-progress-bar):not(html.animation-ready .mobile-menu):not(html.animation-ready .mobile-menu-content):not(html.animation-ready .search-dropdown):not(html.animation-ready .search-dropdown *):not(html.animation-ready .accordion):not(html.animation-ready .accordion *):not(html.animation-ready [data-accordion]):not(html.animation-ready [data-accordion] *):not(html.animation-ready .full-table):not(html.animation-ready .full-table *):not(html.animation-ready [data-full-table]):not(html.animation-ready [data-full-table] *):not([class*="table"]):not([class*="table"] *):not(html.animation-ready button):not(html.animation-ready button *):not([role="button"]):not([role="button"] *):not([class*="collapse"]):not([class*="collapse"] *):not([class*="expand"]):not([class*="expand"] *) {
