...
interface ScrollPositionMemoryProps {
   ...
   * 例如: 'newsPage', 'casesPage', 'productsPage'
   */
  storageKey: string;
 ...
 * 为链接添加详情页返回标记的工具函数
 * 
 * @param selector 链接选择器，例如 `a[href^="/${locale}/news/"]`
 * @param backFromDetailKey 返回标记键名，例如 'backFromNewsDetail'
 */
export function setupDetailPageLinks(selector: string, backFromDetailKey: string) {
