...
export default function ClassificationEquipmentPageClient({ locale, initialData = [] }: ClassificationEquipmentPageClientProps) {
  ...
  const memoryComponent = (
    <ScrollPositionMemoryWithLinks
      storageKey="classificationEquipmentPageState"
      backFromDetailKey="backFromProductDetail"
      locale={locale}
      linkPathPrefix="products/ore-processing/classification-equipment"
  ...
  const pageDescription = isZh
    ...
    : 'Zexin high-efficiency classification equipment includes high weir and submerged spiral classifiers. Wear-resistant design delivers precise particle size control with high processing capacity and low energy consumption, ideal for metallic and non-metallic ore separation.';
