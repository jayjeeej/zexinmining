...
interface ClientClassificationEquipmentDetailProps {
  locale: string;
...
export default function ClientClassificationEquipmentDetail({
  locale,
  productData,
  specifications,
  applications,
  ...
  faqs,
  relatedProducts
}: ClientClassificationEquipmentDetailProps) {
    ...
    <>
      ...
      {relatedProducts.length > 0 && (
        <RelatedProducts
          products={relatedProducts.map(product => ({
            ...
            title: product.title || '',
            imageSrc: product.imageSrc || '/images/products/classification-equipment/placeholder.jpg',
            href: product.href || '#',
      ...
      <div className="-mt-16 lg:-mt-32">
        <ContactCard
          ...
          formType="classification-equipment"
        />
      </div>
    </>
  );
