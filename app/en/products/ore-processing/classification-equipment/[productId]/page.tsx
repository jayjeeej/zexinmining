...
export default async function ProductDetailPage({ params }: { params: { productId: string; locale: string } }) {
  try {
    ...
    const breadcrumbItems = [
      ...
      { name: 'Classification Equipment', url: '/en/products/ore-processing/classification-equipment' },
      { name: product.title, url: `/en/products/ore-processing/classification-equipment/${productId}` }
    ];
