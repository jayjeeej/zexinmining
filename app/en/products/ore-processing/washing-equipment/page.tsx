...
export async function generateMetadata({ params }: { params: { locale: string } }): Promise<Metadata> {
  ...
  try {
    ...
    // 提供默认元数据，避免渲染错误
    return {
      title: 'Washing Equipment | Zexin Mining',
      description: 'Zexin Mining Equipment specializes in manufacturing various washing equipment including single shaft screw washers, twin shaft log washers, double spiral washers, drum washers and log washers.',
      keywords: 'washing equipment,screw washer,twin shaft log washer,double spiral washer,drum washer,log washer,mineral washing equipment,aggregate washing equipment,Zexin Mining',
      openGraph: {
        title: 'Washing Equipment | Zexin Mining',
        description: 'Zexin Mining Equipment specializes in manufacturing various washing equipment for mineral processing and aggregate production applications.'
      }
    };
  }
}
