...
export default function GravitySeparationPageClient({ locale, initialData = [] }: GravitySeparationPageClientProps) {
  ...
  const pageDescription = isZh
    ...
    : 'Zexin high-efficiency gravity separation equipment includes spiral chutes, jig machines, shaking tables and centrifugal concentrators. Utilizing mineral density differences for precise separation with high recovery rates, ideal for gold, tin and tungsten processing with minimal environmental impact.';
