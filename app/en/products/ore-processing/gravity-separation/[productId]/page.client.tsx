...
interface ClientGravitySeparationDetailProps {
  locale: string;
...
export default function ClientGravitySeparationDetail({
  locale,
  productData,
  specifications,
  applications,
  ...
  faqs,
  relatedProducts
}: ClientGravitySeparationDetailProps) {
      ...
      {caseStudies.length > 0 && (
        <ProductCaseStudies
          caseStudies={caseStudies.map(cs => ({
            ...
            imageSrc: typeof cs.imageSrc === 'string' ? cs.imageSrc : '',
            href: typeof cs.href === 'string' ? cs.href : ''
          }))}
          locale={locale}
        />
      )}
      ...
      {relatedProducts.length > 0 && (
        <RelatedProducts
          products={relatedProducts.map(product => ({
            ...
            title: product.title || '',
            imageSrc: product.imageSrc || '/images/products/gravity-separation/placeholder.jpg',
            href: product.href || '#',
