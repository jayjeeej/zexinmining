...
export default async function ProductDetailPage({ 
  ...
  try {
    ...
    // 验证产品是否属于固定式破碎机类别
    if (product.subcategory !== 'stationary-crushers') {
    ...
    const breadcrumbItems = [
      ...
      { name: 'Stationary Crushers', url: '/en/products/ore-processing/stationary-crushers' },
      { name: product.title, url: `/en/products/ore-processing/stationary-crushers/${productId}` }
    ];
    ...
    const categoryStructuredData = getProductCategoryStructuredData({
      ...
      categoryName: 'Stationary Crushers',
      description: 'Zexin Mining Equipment provides a range of efficient stationary crushers for various ore crushing applications',
      locale: locale,
      baseUrl: baseUrl
    });
