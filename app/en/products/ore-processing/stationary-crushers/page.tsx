...
export default async function StationaryCrushersPage() {
  console.log("[SERVER] 开始渲染英文版StationaryCrushersPage");
  ...
  const breadcrumbItems = [
    ...
    { name: isZh ? '选矿设备' : 'Ore Processing Equipment', href: '/en/products/ore-processing' },
