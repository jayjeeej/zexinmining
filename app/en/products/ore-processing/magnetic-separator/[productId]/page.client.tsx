...
interface ClientMagneticSeparatorDetailProps {
  locale: string;
...
export default function ClientMagneticSeparatorDetail({
  locale,
  productData,
  specifications,
  applications,
  ...
  faqs,
  relatedProducts
}: ClientMagneticSeparatorDetailProps) {
      ...
      {relatedProducts.length > 0 && (
        <RelatedProducts
          products={relatedProducts.map(product => ({
            ...
            title: product.title || '',
            imageSrc: product.imageSrc || '/images/products/magnetic-separator/placeholder.jpg',
            href: product.href || '#',
