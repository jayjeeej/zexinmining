...
export default function FlotationEquipmentPageClient({ locale, initialData = [] }: FlotationEquipmentPageClientProps) {
  ...
  const memoryComponent = (
    <ScrollPositionMemoryWithLinks
      storageKey="flotationEquipmentPageState"
      backFromDetailKey="backFromProductDetail"
      locale={locale}
      linkPathPrefix="products/ore-processing/flotation-equipment"
  ...
  const breadcrumbItems = [
    ...
    { name: breadcrumbConfig.categories?.['flotation-equipment']?.name || (isZh ? "浮选设备" : "Flotation Equipment") }
  ];
  ...
  const pageDescription = isZh
    ...
    : 'Zexin high-efficiency flotation equipment includes pneumatic, self-aspirated and XFC air inflation flotation cells. Features high mineralization rates for ferrous, non-ferrous and non-metallic minerals, with low energy consumption, easy operation and high recovery rates.';
