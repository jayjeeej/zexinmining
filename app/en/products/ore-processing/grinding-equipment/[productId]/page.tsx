...
export default async function ProductDetailPage({ 
  ...
  try {
    ...
    const categoryStructuredData = getProductCategoryStructuredData({
      ...
      description: 'High-efficiency grinding equipment for various ore grinding requirements',
      locale: locale,
      baseUrl: baseUrl
    });
    ...
    // 创建WebPage结构化数据
    const pageUrl = `${baseUrl}/${locale}/products/ore-processing/grinding-equipment/${productId}`;
