  ...
  return (
    <>
      ...
      <div className="-mt-16 lg:-mt-32">
        <ContactCard
          title={isZh ? "需要振动筛解决方案？" : "Need Vibrating Screen Solutions?"}
          description={isZh ? "我们的专业工程师团队随时为您提供技术咨询和定制振动筛方案。<br>联系我们获取更多振动筛的详细信息和应用建议！" : "Our professional engineering team is always ready to provide technical consultation and customized vibrating screen solutions.<br>Contact us for more details and application advice on our vibrating screens!"}
          buttonText={isZh ? "联系我们" : "Contact Us"}
          linkUrl=""
          imageSrc="/images/mineral-processing/contact-support.jpg"
          imageAlt={isZh ? "振动筛技术支持" : "Vibrating Screen Support"}
          rounded={false}
          formTitle={{ 
            zh: '振动筛咨询', 
