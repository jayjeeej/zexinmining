...
export default function MineralProcessingSolutionsClient({ locale }: MineralProcessingSolutionsClientProps) {
  ...
  const mineralCategories = [
    {
      ...
      items: [
        { name: isZh ? '金矿选矿工艺流程' : 'Gold Benenficiation Process Flow', link: `/${locale}/products/mineral-processing-solutions/precious-metals/gold` },
        { name: isZh ? '砂金矿选矿工艺流程' :'Placer Gold Benenficiation Process Flow', link: `/${locale}/products/mineral-processing-solutions/precious-metals/placer-gold` },
        { name: isZh ? '银矿选矿工艺流程' : 'Silver Ore Benenficiation Process Flow', link: `/${locale}/products/mineral-processing-solutions/precious-metals/silver` }
      ]
    },
    {
      id: 'non-ferrous',
      ...
      items: [
        { name: isZh ? '锡矿选矿工艺流程' : 'Tin Ore Benenficiation Process Flow', link: `/${locale}/products/mineral-processing-solutions/non-ferrous/tin` },
        { name: isZh ? '锑矿选矿工艺流程' : 'Antimony Ore Benenficiation Process Flow', link: `/${locale}/products/mineral-processing-solutions/non-ferrous/antimony` },
        { name: isZh ? '黑钨选矿工艺流程' : 'Black Tungsten Benenficiation Process Flow', link: `/${locale}/products/mineral-processing-solutions/non-ferrous/black-tungsten` },
        { name: isZh ? '铜铅锌矿选矿工艺流程' : 'Copper-Lead-Zinc Ore Benenficiation Process Flow', link: `/${locale}/products/mineral-processing-solutions/non-ferrous/copper-lead-zinc` },
        { name: isZh ? '钼矿选矿工艺流程' : 'Molybdenum Ore Benenficiation Process Flow', link: `/${locale}/products/mineral-processing-solutions/non-ferrous/molybdenum` }
      ]
    },
    {
      id: 'ferrous',
      ...
      items: [
        { name: isZh ? '铬矿选矿工艺流程' : 'Chrome Beneficiation Process Flow', link: `/${locale}/products/mineral-processing-solutions/ferrous/chrome` },
        { name: isZh ? '磁铁矿选矿工艺流程' : 'Magnetite Beneficiation Process Flow', link: `/${locale}/products/mineral-processing-solutions/ferrous/magnetite` },
        { name: isZh ? '赤铁矿选矿工艺流程' : 'Hematite Beneficiation Process Flow', link: `/${locale}/products/mineral-processing-solutions/ferrous/hematite` },
        { name: isZh ? '锰矿选矿工艺流程' : 'Manganese Ore Beneficiation Process Flow', link: `/${locale}/products/mineral-processing-solutions/ferrous/manganese` }
      ]
    },
    {
      id: 'non-metallic',
      ...
      items: [
        { name: isZh ? '长石矿选矿工艺流程' : 'Feldspar Beneficiation Process Flow', link: `/${locale}/products/mineral-processing-solutions/non-metallic/feldspar` },
        { name: isZh ? '萤石选矿工艺流程' : 'Fluorite Beneficiation Process Flow', link: `/${locale}/products/mineral-processing-solutions/non-metallic/fluorite` },
        { name: isZh ? '石墨选矿工艺流程' : 'Graphite Beneficiation Process Flow', link: `/${locale}/products/mineral-processing-solutions/non-metallic/graphite` },
        { name: isZh ? '重晶石选矿工艺流程' : 'Barite Beneficiation Process Flow', link: `/${locale}/products/mineral-processing-solutions/non-metallic/barite` },
        { name: isZh ? '磷矿选矿工艺流程' : 'Phosphorite Benenficiation Process Flow', link: `/${locale}/products/mineral-processing-solutions/non-metallic/phosphorite` }
      ]
    }
  ];
