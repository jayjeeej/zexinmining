...
export default function SolutionDetailClient({ 
  ...
  function getCategoryName(category: string): string {
    ...
    return categoryNames[category]?.zh || category;
  }
  ...
  return (
    <>
      ...
      <ContactFormModal
        ...
        subjectDefaultValue={`${isZh ? '关于' : 'About '} ${getLocalizedValue(solutionData.mineralName)} ${isZh ? '选矿解决方案的咨询' : ' Processing Solution'}`}
      />
