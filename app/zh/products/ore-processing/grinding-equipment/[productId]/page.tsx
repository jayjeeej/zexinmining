...
export default async function ProductDetailPage({ 
  ...
  try {
    ...
    const breadcrumbItems = [
      ...
      { name: '磨矿设备', url: '/zh/products/ore-processing/grinding-equipment' },
      { name: product.title, url: `/zh/products/ore-processing/grinding-equipment/${productId}` }
    ];
    ...
    const categoryStructuredData = getProductCategoryStructuredData({
      ...
      description: isZh ? '泽鑫矿山设备提供各类高效磨矿设备' : 'Zexin Mining Equipment provides a range of efficient grinding equipment',
      locale: locale,
      baseUrl: baseUrl
    });
