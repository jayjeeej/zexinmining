...
export default function WashingEquipmentPageClient({ locale, initialData = [] }: WashingEquipmentPageClientProps) {
  ...
  const memoryComponent = (
    <ScrollPositionMemoryWithLinks
      storageKey="washingEquipmentPageState"
      backFromDetailKey="backFromProductDetail"
      locale={locale}
      linkPathPrefix="products/ore-processing/washing-equipment"
  ...
  const pageDescription = isZh
    ? '泽鑫提供高效洗矿设备，包括螺旋洗矿机、双轴洗矿机和轮斗洗砂机，采用耐磨材料设计，确保高效清洗性能，低水耗节能运行，矿石杂质去除率高，延长下游设备使用寿命。'
