...
interface ClientWashingEquipmentDetailProps {
  locale: string;
...
export default function ClientWashingEquipmentDetail({
  locale,
  productData,
  specifications,
  applications,
  ...
  faqs,
  relatedProducts
}: ClientWashingEquipmentDetailProps) {
  ...
  return (
    <>
      ...
      {relatedProducts.length > 0 && (
        <RelatedProducts
          products={relatedProducts.map(product => ({
            ...
            title: product.title || '',
            imageSrc: product.imageSrc || '/images/products/washing-equipment/placeholder.jpg',
            href: product.href || '#',
      ...
      <div className="-mt-16 lg:-mt-32">
        <ContactCard
          title={isZh ? "需要洗选设备解决方案？" : "Need Washing Equipment Solutions?"}
          description={isZh ? "我们的专业工程师团队随时为您提供技术咨询和定制洗选设备方案。<br>联系我们获取更多洗选设备的详细信息和应用建议！" : "Our professional engineering team is always ready to provide technical consultation and customized washing solutions.<br>Contact us for more details and application advice on our washing equipment!"}
          buttonText={isZh ? "联系我们" : "Contact Us"}
          linkUrl=""
          imageSrc="/images/mineral-processing/contact-support.jpg"
          imageAlt={isZh ? "洗选设备技术支持" : "Washing Equipment Support"}
          rounded={false}
          formTitle={{ 
            zh: '洗选设备咨询', 
            en: 'Washing Equipment Inquiry' 
          }}
          formSubtitle={{ 
            zh: '请填写以下表单，我们的专业工程师团队将尽快与您联系', 
            en: 'Please fill in the form below, and our professional team will contact you shortly' 
          }}
          formType="washing-equipment"
        />
      </div>
    </>
  );
