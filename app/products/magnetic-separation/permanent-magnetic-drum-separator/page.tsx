...
export default function PermanentMagneticDrumSeparatorPage() {
  const { language, isZh } = useLanguage();
  const [productData, setProductData] = useState<any>(null);
  const [loading, setLoading] = useState(true);
  const productId = "permanent-magnetic-drum-separator";
  ...
  const templateProps: any = {
    ...
    magneticFieldStrength: latestParams.magneticFieldStrength,
